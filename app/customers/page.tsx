...
export default async function Customers() {
  ...
  const { data } = await db.from("customers").select("id,customer_number,name,address_line,postal_code,city,phone,email,priority,status,geocode_status").order("created_at", { ascending: false }).limit(200);
